...
5. [Datenquellen und Import](#datenquellen-und-import)
6. [Datenbankschema](#datenbankschema)
7. [Schnittstellen (APIs, Skripte, OCR)](#schnittstellen-apis-skripte-ocr)
8. [Hauptmenü und Untermenüs](#hauptmenü-und-untermenüs)
9. [OCR-Agent](#ocr-agent)
10. [Backup & Restore](#backup--restore)
11. [Web-Applikation (UI im Browser)](#web-applikation-ui-im-browser)
12. [Wichtige Skripte im Detail](#wichtige-skripte-im-detail)
13. [Arbeitsabläufe](#arbeitsabläufe)
14. [Hinweise und Best Practices](#hinweise-und-best-practices)
...
- Transparenz für Bürger:innen und Gemeinderat.
...
## Installation
1. Abhängigkeiten mit Homebrew installieren: `colima`, `docker`, `docker-compose`, `qpdf`, `poppler`, `tesseract`, `imagemagick`, `ghostscript`, `python@3.11`, `node`, `npm`.
...
Automatische Backups erfolgen wöchentlich Montag um 03:00 Uhr über einen Launchd-Job.
...
Benutzer:innen können die Daten direkt im Browser durchsuchen, filtern und herunterladen.
...
## Arbeitsabläufe
1. Stack über das Menü starten.
2. Dokumente (PDFs, CSVs) in `input/` ablegen oder über das Menü importieren.
...
- Immer sicherstellen, dass Colima und Docker laufen, bevor ein Import gestartet wird.
- OCR-Agent kontinuierlich laufen lassen, um neue Dokumente sofort zu verarbeiten.
- Gesperrte PDFs zuerst entsperren lassen, bevor die OCR startet.
- Backups regelmäßig prüfen.
- Web-Applikation für Bürger:innen so gestalten, dass die Suche und Anzeige intuitiv sind.
